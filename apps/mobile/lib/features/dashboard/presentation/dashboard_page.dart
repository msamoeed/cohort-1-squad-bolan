...
class DashboardPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final firstName = profileAsync.maybeWhen(
      data: (profile) => profile.displayFirstName,
      orElse: () => '',
    );
    ...
    return metricsAsync.when(
          ...
          children: [
            Row(
              children: [
                const CircleAvatar(
                  ...
                  child: Icon(Icons.storefront_rounded, color: AppColors.brand),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Here is today’s collection picture',
            ...
            Row(
              children: [
                _Metric(
                  label: 'Overdue',
                  value: '${metrics.overdueTotal.toInt()}',
            ...
            if (metrics.overdueTotal <= 0)
              const Padding(
                ...
                child: Text('No overdue payments. Great work!'),
              ),
          ],
        ),
      ),
      ...
      error: (error, stackTrace) => const SafeArea(
        child: Center(child: Text('Unable to load dashboard data.')),
      ),
    );
  }
}
